...
const EVACUATION_CENTERS = [
  ...
  { id: 'hall', name: 'Sitio Talipapa Barangay Hall', capacity: 300, readiness: 'Fair', points: 8, icon: Building2, color: 'bg-orange-100 text-orange-600' },
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h3 className="font-bold mb-3">Location Profile: Barangay Kiling, Sariaya, Quezon</h3>
